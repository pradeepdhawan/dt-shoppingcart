...
{
    public class SinglePercentageDiscountTest
    {
        ...
        public SinglePercentageDiscountTest(ITestOutputHelper outputHelper)
        {
            ...
            IDiscountParameters buy2ButterGet50percentOffEverything = new DiscountParameters(DiscountType.Percentage, new List<ICartItem>() { new CartItem(butter, 2) }, null, 50.0);

            discounts = new List<IDiscountParameters>() { buy2ButterGet50percentOffEverything };
        }
        [Theory]
        ...
        [InlineData(2, 0, 2, 1.80, 3.60, 1, "Given the basket has 2 butter and 2 bread when I total the basket then the total should be £3.60")]
        ...
        [InlineData(2, 8, 1, 5.90, 11.80, 1, "Given the basket has 2 butter, 1 bread and 8 milk when I total the basket then the total should be £5.9")]
        //Given the basket has 4 butter, 1 bread and 8 milk when I total the basket then the total should be £9.00
        [InlineData(4, 8, 1, 6.70, 13.40, 1, "Given the basket has 4 butter, 1 bread and 8 milk when I total the basket then the total should be £6.7")]
