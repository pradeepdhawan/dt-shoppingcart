...
{
    public class SingleAbsoluteDiscountTest
    {
        ...
        public SingleAbsoluteDiscountTest(ITestOutputHelper outputHelper)
        {
            ...
            IDiscountParameters buy3ButterGet1PoundOff = new DiscountParameters(DiscountType.Absolute, new List<ICartItem>() { new CartItem(butter, 3) }, null, 1.0);

            discounts = new List<IDiscountParameters>() { buy3ButterGet1PoundOff };
        }
        [Theory]
        ...
        [InlineData(8, 8, 1, 14.6, 16.6, 2, "Given the basket has 2 butter, 1 bread and 8 milk when I total the basket then the total should be £14.6")]
        //Given the basket has 4 butter, 1 bread and 8 milk when I total the basket then the total should be £9.00
        [InlineData(4, 8, 1, 12.40, 13.40, 1, "Given the basket has 4 butter, 1 bread and 8 milk when I total the basket then the total should be £12.4")]
